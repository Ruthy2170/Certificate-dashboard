import { Trophy, Mail, Lock, User, ArrowRight, Eye, EyeOff, Phone } from 'lucide-react';
...
export default function SignUpPage() {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/30">
      {/* Left Side - Branding */}
      <div className="hidden lg:flex lg:w-1/2 lg:flex-col lg:justify-center lg:bg-gradient-to-br lg:from-purple-600 lg:to-blue-600 lg:p-12">
        <div className="mx-auto max-w-md">
          <div className="mb-8 flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white">AchieveHub</h1>
          ...
          <p className="mb-8 text-lg text-blue-100">
            Join thousands of learners and start earning certifications today.
          </p>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4 rounded-xl bg-white/10 p-4 backdrop-blur-sm">
              ...
              <div>
                <p className="font-semibold text-white">Earn Achievements</p>
                <p className="text-sm text-blue-100">Unlock badges and rewards</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 rounded-xl bg-white/10 p-4 backdrop-blur-sm">
              ...
              <div>
                <p className="font-semibold text-white">Get Certified</p>
                <p className="text-sm text-blue-100">Prove your expertise</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 rounded-xl bg-white/10 p-4 backdrop-blur-sm">
              ...
              <div>
                ...
                <p className="text-sm text-blue-100">Monitor your growth</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex w-full items-center justify-center p-8 lg:w-1/2">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8 flex items-center justify-center gap-3 lg:hidden">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">AchieveHub</h1>
          ...
          <div className="rounded-2xl bg-white p-8 shadow-xl">
            ...
            <form onSubmit={handleSignUp} className="space-y-5">
              ...
              <div className="flex items-start">
                <input
                  type="checkbox"
                  className="mt-1 size-4 rounded border-gray-300 text-blue-600 focus:ring-2 focus:ring-blue-500/20"
                  required
                />
