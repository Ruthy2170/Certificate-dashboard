import { Trophy, LayoutDashboard, Shield, User, LogOut, Menu, X, Flame } from 'lucide-react';
...
export default function Layout() {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/30">
      {/* Sidebar */}
      <aside className={`fixed inset-y-0 left-0 z-50 w-72 transform bg-white shadow-xl transition-transform duration-300 ease-in-out lg:relative lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="flex h-full flex-col">
          ...
          <div className="flex items-center justify-between p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="block text-lg font-bold text-gray-900">AchieveHub</span>
                <span className="block text-xs text-gray-500">Learning Platform</span>
              </div>
            </div>
            <button
          ...
          <div className="mx-4 mb-4 rounded-xl bg-gradient-to-br from-blue-500 to-purple-600 p-5">
            ...
            <div className="mt-3 flex items-center justify-between rounded-lg bg-white/20 px-3 py-2 backdrop-blur-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-white">{userData.currentStreak} Day Streak</span>
              </div>
              <span className="rounded-full bg-white/30 px-2 py-0.5 text-xs font-semibold text-white">{userData.totalPoints} pts</span>
            </div>
          </div>
        ...
        <header className="sticky top-0 z-30 border-b border-gray-200 bg-white/80 px-6 py-4 backdrop-blur-lg lg:hidden">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-gray-900">AchieveHub</span>
            </div>
          </div>
        </header>
